...
def chat():
    ...
    try:
        ...
        SYS_TEXT = (
            ...
            "Divide this section into 4 subsections called: A. Mechanism; B. Quantitaive Data and C. Severity."
            "- **Mechanism**: State in a paragraph the primary biochemical or physiological pathway "
            "(e.g., Enzyme inhibition, transporter blockade, receptor antagonism).\n"
            "- **Quantitative Data**: List all numerical values found in [SEARCH_DATA] "
            "verbatim (e.g., $IC_{50}$, Risk Ratios, case counts, or percentage frequencies).\n"
            "- **Severity**: Define the symptom spectrum using strictly CTCAE Grade 1-4 definitions.\n\n"
            "**SECTION III: DATA & REFERENCES**\n"
